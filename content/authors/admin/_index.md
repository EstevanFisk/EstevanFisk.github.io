---
# Display name
title: Estevan Fisk Data Scientist
...
organizations:
  - name: Air Force Cost Analysis Agency (AFCAA)
    url: https://www.saffm.hq.af.mil/
...
profiles:
  ...
  - icon: brands/linkedin
    url: https://www.linkedin.com/in/estevanfisk/
  - icon: custom/kaggle
    url: https://www.kaggle.com/bgfootball04
...
education:
  - area: MS Statistics
    ...
    date_end: 2020-05-31
    summary: |
      Capstone project _Client Based Neural Language Project_. ·  Used enriched data to rank and cluster over 2,600 restaurants, combining internal data and external unstructured text data for feature engineering using natural language processing with 90% accuracy.
    # button:
    #   text: 'Read Thesis'
